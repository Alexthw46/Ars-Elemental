...
public class GrowMixin implements IDamageEffect {
    ...
    public boolean canDamage(LivingEntity shooter, SpellStats stats, SpellContext spellContext, SpellResolver resolver, @NotNull Entity entity) {
        return entity instanceof LivingEntity living && !(living.getHealth() <= 0 || entity.isAlliedTo(shooter)) && living.getMobType() == MobType.UNDEAD && ISchoolFocus.hasFocus(shooter) == SpellSchools.ELEMENTAL_EARTH;
    }
