...
public class AEGlyphProvider extends GlyphRecipeProvider {
    ...
    public void collectJsons(CachedOutput cache) {
        ...
        addRecipe(EffectCauterize.INSTANCE, ItemsRegistry.FIRE_ESSENCE, ItemsRegistry.ABJURATION_ESSENCE, Items.BLAZE_POWDER, Items.GHAST_TEAR);
        addRecipe(EffectRage.INSTANCE, ItemsRegistry.FIRE_ESSENCE, ModRegistry.ANIMA_ESSENCE.get(), ItemsRegistry.WILDEN_HORN, Items.RED_CARPET, Items.FERMENTED_SPIDER_EYE);
        ...
        condition.addProperty("type", "sauce:ae_config");
