...
public class AETagsProvider {
    ...
    public static class AEItemTagsProvider extends ItemTagsProvider {
        ...
        protected void addTags() {
            ...
            tag(ModRegistry.CURIO_BAGGABLE).add(ItemsRegistry.WORN_NOTEBOOK.get(), ItemsRegistry.DOMINION_ROD.get(), ItemsRegistry.DOWSING_ROD.get(), ItemsRegistry.JAR_OF_LIGHT.get(), ItemsRegistry.VOID_JAR.get(), ItemsRegistry.RUNIC_CHALK.get(), ItemsRegistry.WARP_SCROLL.get(), ItemsRegistry.SPELL_PARCHMENT.get()).addTag(SUMMON_SHARDS);
