...
public class AELangDatagen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("effect.ars_elemental.rust.description", "Makes the entity armor rust temporarily, dropping its armor points.");
        ...
        add("ars_elemental.page1.flashjack_charm", "Flashjacks are usually found in archwood forests, hiding among the trees, or in high mountainous peaks. You can befriend a wild flashjack by giving them a flashpine. Their job is tied to base defense, but in a different way than Flarecannons and Weald Walkers, acting as a scout in its home area.");
        add("ars_elemental.page2.flashjack_charm", "You can link the bird to a set of adjustable or elemental turrets and it will be able to hijack them to aim and shoot at its target, it will also highlight its target and warn nearby weald walkers. Mob types can be excluded by its targeting using the dominion wand.");
        ...
        add("ars_elemental.armor_set.fire.name", "Fire's Ward");
        ...
        add("ars_elemental.armor_set.water.name", "Water's Embrace");
        ...
        add("ars_elemental.armor_set.earth.name", "Earth's Nourishment");
        ...
        add("ars_elemental.armor_set.air.name", "Air's Grace");
        add("ars_elemental.armor_set.air.desc", "Absorb some air-related damage, highly reduce fall damage.");
        add("ars_elemental.armor_set.school_set.desc", "(4 same element pieces).");
        add("ars_elemental.armor_set.set_bonus.desc", "(2 or more set pieces).");
        add("ars_elemental.armor_set.light.name", "Sorcerer's Fury");
        ...
        add("ars_elemental.armor_set.medium.name", "Arcanist's Wisdom");
        ...
        add("ars_elemental.armor_set.heavy.name", "Battlemage's Resilience");
