...
public class WorldEvents {
    ...
    public static Holder<ConfiguredFeature<TreeConfiguration, ?>> FLASHING_TREE = FeatureUtils.register("ars_elemental:flashing_feature", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(new SupplierBlockStateProvider(LibBlockNames.AB_CLOVER),
            new MagicTrunkPlacer(9, 1, 0),
            new SupplierBlockStateProvider(LibBlockNames.SOURCE_GEM_BLOCK),
    ...
    public static void registerFeature(RegistryEvent.Register<Block> e) {
        ...
        PLACED_FLASHING_CONFIGURED = PlacementUtils.register("ars_elemental:archwood", ARCHWOOD_TREES, VegetationPlacements.treePlacement(RarityFilter.onAverageOnceEvery(Config.TREE_SPAWN_RATE.get() / 4)));
    }
